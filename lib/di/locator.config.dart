...
import '../domain/use_case/impl/score_use_case_impl.dart' as _i15;
import '../domain/use_case/score_use_case.dart' as _i14;
...
import '../view/pages/score/score_manager.dart'
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i14.GetScoresUseCase>(
      () => _i15.GetScoreUseCaseImpl(get<_i12.ScoreRepository>()));
  gh.factory<_i14.SaveScoreUseCase>(
      () => _i15.SaveScoreUseCaseImpl(get<_i12.ScoreRepository>()));
  return get;
}
